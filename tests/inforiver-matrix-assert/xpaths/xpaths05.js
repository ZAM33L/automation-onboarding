...
const xpaths05 = {
    ...
    cellValue: `(//span[@role='cell' and text()='${data05.matrixCellValue00}'])[1]`,
    ...
    boldOption: `//div[@data-label='${data05.tabListItem01}']//span[contains(@class,'${data05.boldClass}')]`,
    underlineOption: `//div[@data-label='${data05.tabListItem01}']//span[contains(@class,'${data05.underlineClass}')]`,
    italicOption: `//div[@data-label='${data05.tabListItem01}']//span[contains(@class,'${data05.italicClass}')]`,
    ...
    fillColorPaletteColor: `//div[@class='bf-ui-colopicker-modal']/div[@class='bf-ui-colopicker-Palette']//*[local-name()='svg']//*[local-name()='rect' and @fill='${data05.paletteColor}']`,
    ...
    fillColorCustomColorTypeDivMenuOption: `//span[text()='${data05.colorCode01}']`,
    fillColorCustomColorTypeDivMenuResult: `//div[@aria-haspopup='listbox']//*[text()='${data05.colorCode01}']`,
    ...
    fontColorPaletteColor: `//div[@class='bf-ui-colopicker-modal']/div[@class='bf-ui-colopicker-Palette']//*[local-name()='svg']//*[local-name()='rect' and @fill='${data05.paletteColor}']`,
    ...
    fontColorCustomColorTypeDivMenuOption: `//span[text()='${data05.colorCode01}']`,
    fontColorCustomColorTypeDivMenuResult: `//div[@aria-haspopup='listbox']//*[text()='${data05.colorCode01}']`,
