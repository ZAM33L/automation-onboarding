module.exports = {
    ...
    boldClass:'bold',
    boldResultStyle:'font-weight',

    underlineClass:'underline',
    underlineResultSyle:'text-decoration-line: underline',
    ...
    //for blue
    paletteFillColorRGB:'background: rgb(17, 141, 255)',
    paletteFontColorRGB:'color: rgb(17, 141, 255)',

    

    defaultFillColorStyle:'background: rgb(255, 255, 0)',
    defaultFontColorStyle:'color: rgb(255, 0, 10)',
